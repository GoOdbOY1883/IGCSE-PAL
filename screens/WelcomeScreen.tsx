...
const WelcomeScreen: React.FC<WelcomeScreenProps> = ({ onModeSelect, onViewSaved, onViewSavedNotes, onImageEditor }) => {
  return (
      ...
      <div className="w-full max-w-4xl">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <button
            ...
            className="p-8 bg-white border border-gray-200 rounded-xl shadow-lg hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 group"
          >
            <h2 className="text-2xl font-bold text-purple-600 mb-2">AI Image Editor</h2>
            <p className="text-gray-600">
              Upload an image and use AI to edit or transform it with simple text prompts.
            </p>
          </button>
        </div>
